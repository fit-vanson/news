...
class DashboardController extends Controller
{
    ...
    public function getDashboardData(){
		...
		$published_product = Product::where('is_publish', '=', 1)->count();
		$published_category = Pro_category::where('is_publish', '=', 1)->count();
		$published_brand = Brand::where('is_publish', '=', 1)->count();
		$review = Review::count();
