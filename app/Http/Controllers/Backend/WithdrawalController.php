...
//			$data['CurrentBalance'] = $gtext['currency_icon'].number_format($OrderWithdrawalBalance, 2);
			$data['CurrentBalance'] = $gtext['currency_icon'].number_format($OrderWithdrawalBalance,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']);
		}else{
			$data['CurrentBalance'] = number_format($OrderWithdrawalBalance,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']).$gtext['currency_icon'];
		}
