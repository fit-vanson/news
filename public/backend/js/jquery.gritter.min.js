...
function onCustomModal(t, r) {
    $(".m-top-none").html(t), $(".lightCustomModal_close.blue-btn").attr("onClick", r + "()"), $(".lightCustomModal_open").click()
}

jQuery(function () {
    jQuery("#lightCustomModal")
        .popup({pagecontainer: ".container", transition: "all 0.3s"})
});
