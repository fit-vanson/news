...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/backend/getSubscriberTableData?site_id="+site_id+"page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/backend/getSubscriberTableData?site_id="+site_id,
		success:function(data){
			$('#tp_datalist').html(data);
		}
	});
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getSubscriberTableData?site_id="+site_id+"&search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
		}
	});
...
function onSubscribePopupConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/SubscribePopupUpdate?site_id='+site_id,
...
function onSubscriberConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/saveSubscriberData?site_id='+site_id,
