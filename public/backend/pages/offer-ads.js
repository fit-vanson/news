...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/backend/getOfferAdsTableData?site_id="+site_id+"&page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/backend/getOfferAdsTableData?site_id="+site_id,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getOfferAdsTableData??site_id="+site_id+"&search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/saveOfferAdsData?site_id='+site_id,
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/getOfferAdsById?site_id='+site_id,
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
			...
			if(data.desc != null){
				...
				if(obj.bg_color != null){
					$("#bg_color").colorpicker('setValue', obj.bg_color);
				}else{
					$("#bg_color").colorpicker('setValue', '#38a677');
				}
