...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/backend/getSliderTableData?site_id="+site_id+"&page="+page+"&slider_type="+$('#slider_type_filter').val(),
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/backend/getSliderTableData?site_id="+site_id+"&search="+$("#search").val()+"&slider_type="+$('#slider_type_filter').val(),
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/saveSliderData?site_id'+site_id,
