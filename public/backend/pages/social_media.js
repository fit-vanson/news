...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/backend/getSocialMediaTableData?site_id="+site_id+"&page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/backend/getSocialMediaTableData?site_id="+site_id,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getSocialMediaTableData?site_id="+site_id+"&search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/saveSocialMediaData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/getSocialMediaById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
			...
			$("#target").val(data.target).trigger("chosen:updated");
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/deleteSocialMedia',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/bulkActionSocialMedia',
