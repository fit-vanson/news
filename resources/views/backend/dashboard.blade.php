                                        ...
                                        @foreach($newsViewers as $row)
                                            <tr>
                                                <td class="text-left"><a
                                                        href="@if($row->categories) {{ route('backend.news',['site_id'=>$row->categories->site->id, 'news_id'=> $row->id]) }} @endif">{{ htmlDecode(rawurldecode($row->title))  }}</a>
                                                </td>
                                                <td class="text-left"><a
                                                        href="@if($row->categories) {{ route('backend.site',['id'=>$row->categories->site->id]) }} @endif">{{ @$row->categories->site->site_name }}</a>
                                                </td>
