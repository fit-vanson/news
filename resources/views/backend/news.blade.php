                        ...
                        <div class="tabs-body">
                            ...
                            <div id="form-panel" class="card-body dnone">
                                <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="news_title" id="news_title" class="form-control parsley-validated" data-required="true">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="slug">{{ __('Summary') }}<span class="red">*</span></label>
                                                <input type="text" name="summary" id="summary" class="form-control parsley-validated" data-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="original_url" id="original_url" class="form-control parsley-validated">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="breaking_news" id="breaking_news" class="chosen-select form-control">
                                                    @foreach($statuslist as $row)
                                                        <option value="{{ $row->id }}">
                                                            {{ $row->status }}
                                                        </option>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="cate_id" id="cate_id" class="chosen-select form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="tp-upload-field">
                                                    <input type="text" name="thumbnail" id="news_thumbnail" class="form-control" readonly>
                                                ...
                                                <div id="remove_news_thumbnail" class="select-image">
                                                    ...
                                                    <a onClick="onMediaImageRemove('news_thumbnail')" class="media-image-remove" href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="text" name="site_id" id="site_id" class="dnone" value="{{$datalist['id']}}">
