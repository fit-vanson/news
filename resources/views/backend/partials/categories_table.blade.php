<div class="table-responsive">
    <table class="table table-borderless table-theme" style="width:100%;">
        <thead>
        <tr>
            <th class="checkboxlist text-center" style="width:10%"><input class="tp-check-all checkAll" type="checkbox">
            </th>
                ...
                <tr>
                    ...
                    @if ($row->thumbnail != '')
                        <td class="text-center">
                            <div class="table_col_image"><img src="/media/{{ $row->thumbnail }}"/></div>
                        </td>
                    @else
                        <td class="text-center">
                    ...
                    <td class="text-center">
                        ...
                        <div class="btn-group action-group">
                            <a onclick="onEdit({{ $row->id }})" href="javascript:void(0);"><i class="fa fa-edit"
                                                                                              style="font-size: x-large"></i></a>&nbsp;&nbsp;&nbsp;
                            <a onclick="onDelete({{ $row->id }})" href="javascript:void(0);"><i class="fa fa-trash"
                                                                                                style="font-size: x-large"> </i></a>
