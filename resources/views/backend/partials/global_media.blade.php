                            ...
                            <div class="tp-media-left">
                                ...
                                <div class="media-toolbar">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="group-btn">
                                                <a onClick="onUploadFormPanel()" href="javascript:void(0);"
                                                   class="btn blue-btn up-btn-form float-left media-btn"><i
                                                        class="fa fa-upload"></i> {{ __('Upload File') }}</a>
                                                <a onClick="onUploadListPanel()" href="javascript:void(0);"
                                                   class="btn warning-btn up-btn-list float-left media-btn dnone"><i
                                                        class="fa fa-reply"></i> {{ __('Back') }}</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group media-filter">
                                                <input id="global_media_search" name="global_media_search" type="text"
                                                       class="form-control" placeholder="Search...">
                                                <button type="submit" onClick="onGlobalMediaSearch()"
                                                        class="btn media-search-btn">Search
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="upload-form-panel" class="dnone">
                                    <div class="tp-body">
                                        <div class="tp-file-upload">
                                            <input type="file" name="load_attachment" id="load_attachment"
                                                   class="tp-upload">
