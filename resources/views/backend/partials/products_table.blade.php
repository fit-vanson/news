	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-left" style="width:15%">{{ __('Price')}} </th>
				<th class="text-left" style="width:15%">{{ __('Sale Price')}} </th>
...
{{--				<th class="text-center" style="width:10%">{{ __('Language') }}</th>--}}
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left">{{ $row->categories->name }}</td>
				@if($row->brand_id == '0')
                ...
                <td class="text-left">{{ $row->old_price}}</td>
                <td class="text-left">{{ $row->sale_price}}</td>
