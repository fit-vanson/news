...
{{--		<li><a id="active-settings" href="{{ route('backend.general') }}"><i class="fa fa-cogs"></i>{{ __('Settings') }}</a></li>--}}
		...
		@elseif (Auth::user()->role_id == 3)
		    ...
		    <li><a href="{{ route('editor.dashboard') }}"><i class="fa fa-tachometer"></i>{{ __('Dashboard') }}</a></li>
            <li><a href="{{ route('backend.MultipleSites') }}" id="select_MultipleSites"><i class="fa fa-globe"></i>{{ __('Sites') }}</a></li>
