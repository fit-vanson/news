...
{{--    <li><a href="{{ route('backend.page-variation', ['site_id' => @$datalist['id']]) }}"><i class="fa fa-cog"></i>{{ __('Page Variation') }}</a></li>
	<li><a href="{{ route('backend.section-manage', ['site_id' => @$datalist['id']]) }}"><i class="fa fa-cog"></i>{{ __('Section Manage') }}</a></li>--}}
