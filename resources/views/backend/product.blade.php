...
{{--								</div>--}}
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="sale_price">{{ __('Price') }}<span class="red">*</span></label>
                                            <input value="{{ $datalist['old_price'] }}" name="old_price" id="old_price" type="text" class="form-control parsley-validated" data-required="true">
                                        </div>
                                    </div>
...
{{--									</div>--}}
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="sale_price">{{ __('Sale Price Per %') }}<span class="red">*</span></label>
                                            @if(isset($datalist['old_price']))
                                                <input value="{{ number_format((($datalist['old_price']-$datalist['sale_price'])*100)/$datalist['old_price']) }}" name="sale_price_per" id="sale_price_per" type="number" class="form-control parsley-validated" data-required="true">
                                            @else
                                                <input value="0" name="sale_price_per" id="sale_price_per" type="number" class="form-control parsley-validated" data-required="true">
                                            @endif
                                        </div>
                                    </div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<div class="tp-upload-field">
												...
												<input value="{{ $datalist['large_image'] }}" type="text" name="large_image" id="f_large_image_large_image" hidden>
