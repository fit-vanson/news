						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="float-right">
                                    <a onClick="onFormBulk()" href="javascript:void(0);" class="btn btn-warning btn-form float-right"><i class="fa fa-plus"></i> {{ __('Bulk Upload') }}</a>
...
{{--								</div>--}}
                    ...
                    <div id="form-bulk" class="card-body dnone">
                        <form novalidate="" data-validate="parsley" id="Bulk_formId" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <p><a href="/template_products.csv"> Download CSV template</a></p>
                                        <input type="file" name="csv_file" id="csv_file" class="form-control parsley-validated" data-required="true"  accept=".csv" />
                            ...
                            <div class="row tabs-footer mt-15">
                                <div class="col-lg-12">
                                    <a id="submit-form-bulk" href="javascript:void(0);" class="btn blue-btn mr-10">{{ __('Save') }}</a>
                                    <a onClick="onListPanel()" href="javascript:void(0);" class="btn danger-btn">{{ __('Cancel') }}</a>
                                </div>
                            </div>
                        </form>
