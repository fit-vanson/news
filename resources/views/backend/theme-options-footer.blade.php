                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="tp-upload-field">
                                                    <input type="text" value="{{ $datalist['about_logo'] }}"
                                                           name="about_logo" id="about_logo" class="form-control"
                                                           readonly>
                                                    <a id="on_about_logo" href="javascript:void(0);"
                                                ...
                                                <div id="remove_about_logo" class="select-image dnone">
                                                    ...
                                                    <a onClick="onMediaImageRemove('about_logo')"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="about_desc" id="about_desc" class="form-control"
                                                          rows="2">{{ $datalist['about_desc'] }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_publish_about" id="is_publish_about"
                                                        class="chosen-select form-control">
                                                    @foreach($statuslist as $row)
                                                        <option
                                                            {{ $row->id == $datalist['is_publish_about'] ? "selected=selected" : '' }} value="{{ $row->id }}">
                                                            {{ $row->status }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $datalist['address'] }}" type="text" name="address"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $datalist['email'] }}" type="text" name="email"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $datalist['phone'] }}" type="text" name="phone"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_publish_contact" id="is_publish_contact"
                                                        class="chosen-select form-control">
                                                    @foreach($statuslist as $row)
                                                        <option
                                                            {{ $row->id == $datalist['is_publish_contact'] ? "selected=selected" : '' }} value="{{ $row->id }}">
                                                            {{ $row->status }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $datalist['copyright'] }}" type="text" name="copyright"
                                                       id="copyright" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_publish_copyright" id="is_publish_copyright"
                                                    ...
                                                    @foreach($statuslist as $row)
                                                        <option
                                                            {{ $row->id == $datalist['is_publish_copyright'] ? "selected=selected" : '' }} value="{{ $row->id }}">
                                                            {{ $row->status }}
                                                        </option>
                                                    @endforeach
                                                </select>
