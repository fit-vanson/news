								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
                                            ...
                                            <input value="{{ @$social_media['url'] }}" type="text" name="socials_media[{{$key}}][url]" class="form-control">
										</div>
									</div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="about_desc">{{ __('Followers') }}</label>
                                            <input value="{{ @$social_media['followers'] }}" type="number" name="socials_media[{{$key}}][followers]"  class="form-control">
                                        </div>
                                    </div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="socials_media[{{$key}}][is_publish]"  class="chosen-select form-control">
											@foreach($statuslist as $row)
												<option {{ $row->id == @$social_media['is_publish'] ? "selected=selected" : '' }} value="{{ $row->id }}">
													{{ $row->status }}
												</option>
											@endforeach
											</select>
