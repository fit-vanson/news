                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $datalist['web']}}" type="text" name="site_web"
                                                       id="site_web" class="form-control parsley-validated"
                                                       data-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="is_publish">{{ __('Status') }}<span
                                                        class="red">*</span></label>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="address"
                                                          class="form-control parsley-validated" data-required="true"
                                                          rows="2">{{ $datalist['address'] }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="timezone">{{ __('Time Zone') }}<span
                                                        class="red">*</span></label>
                                                <select name="timezone" id="timezone"
                                                        class="chosen-select form-control parsley-validated"
                                                        data-required="true">
                                                    @foreach($timezonelist as $row)
                                                        <option
                                                            {{ $row->timezone == $datalist['timezone'] ? "selected=selected" : '' }} value="{{ $row->timezone }}">
                                                            {{ $row->timezone_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
