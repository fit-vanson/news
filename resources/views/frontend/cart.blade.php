							...
							<tbody>
								...
								@php
									...
									if($gtext['currency_position'] == 'left'){
										$price = $gtext['currency_icon'].number_format($pro_price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']);
									}else{
										$price = number_format($pro_price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']).$gtext['currency_icon'];
									}

									if($gtext['currency_position'] == 'left'){
										$totalPrice = $gtext['currency_icon'].number_format($total_Price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']);
									}else{
										$totalPrice = number_format($total_Price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']).$gtext['currency_icon'];
									}
