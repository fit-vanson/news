            ...
            <div class="col-md-9 col-xl-10">
                <div class="maan-slide-text">
                    ...
                    @if($breaking_news->categories)
                        ...
                        {{ route(strtolower($breaking_news->categories->slug).'.details',$breaking_news->id) }}
                            @endif
                        @endif
                            ">
                                {{ rawurldecode($breaking_news->title) }}
                            </a></p>
                    @endforeach
