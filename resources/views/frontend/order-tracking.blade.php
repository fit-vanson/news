										...
										<tbody>
											...
											@php
												if($gtext['currency_position'] == 'left'){
													$price = $gtext['currency_icon'].number_format($row->price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']);
													$total_price = $gtext['currency_icon'].number_format($row->total_price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']);
												}else{
													$price = number_format($row->price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']).$gtext['currency_icon'];
													$total_price = number_format($row->total_price,$gtext['decimal_digit'],$gtext['decimal_separator'],$gtext['thousands_separator']).$gtext['currency_icon'];
												}
