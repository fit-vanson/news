                ...
                @foreach($newsLatest as $item)
                    <div class="@if($loop->first) col-lg-6 topnews-big-card  @else col-lg-3 @endif">
                        <div class="card maan-card-img">
                            ...
                            @endif
                            <span
                                class="maan-tag-@if($loop->iteration==1)parpul @elseif($loop->iteration==2)green @elseif($loop->iteration==3)blue @elseif($loop->iteration==4)red  @endif">{{ rawurldecode($item->categories->name) }}</span>
                            <div class="card-body maan-card-body">
                                <div class="maan-text">
                                    ...
                                    @endif
                                        ">
                                            {{ htmlDecode(rawurldecode($item->title)) }}
                                    ...
                                    <ul>
                                        ...
                                        <li class="author-date">
                                            <span class="maan-icon"><svg viewBox="0 0 512 512"><path
                                                        ...
                                                        d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"/></svg></span>
                                            <span
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card maan-card-img">
                            <a class="topcategories-thumb"
                               href="@if(Route::has(strtolower($category->slug))){{ route(strtolower($category->slug),$category->name) }}@endif">
                        ...
                        @foreach($newsRandom as $item)
                            <div class="card maan-big-post">
                                ...
                                <div class="card-body maan-card-body pb-0">
                                    <div class="maan-text">
                                        <h4>
                                            <a href="@if($item->categories->slug){{ route( strtolower($item->categories->slug).'.details',['id'=>$item->id,'slug'=>$item->slug]) }} @endif">{{ htmlDecode(rawurldecode($item->title)) }}</a>
                                        </h4>
                                        <ul>
                                            <li class="author">
                                            <span class="maan-icon">
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="all-news-tab" data-bs-toggle="pill"
                                        data-bs-target="#all-news" type="button">{{ __('All') }}</button>
                            </li>
                            @foreach($categories as $category)
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="{{rawurldecode($category->slug)}}-tab"
                                            data-bs-toggle="pill" data-bs-target="#{{rawurldecode($category->slug)}}"
                                            type="button">{{rawurldecode($category->name)}}</button>
                                </li>
                            @endforeach
                        </ul>
                                            ...
                                            @if($loop->iteration<=3)
                                                <li>
                                                    ...
                                                    <div class="maan-list-text">
                                                        <span
                                                            class="maan-tag-@if($loop->iteration==1)green @elseif($loop->iteration==2)red @elseif($loop->iteration==3)blue @elseif($loop->iteration==4)parpul  @endif">{{ rawurldecode($item->categories->name) }}</span>
                                                        <h4>
                                                            <a href="@if($item->categories->slug){{ route(strtolower($item->categories->slug).'.details',['id'=>$item->id,'slug'=>$item->slug]) }}@endif">{{ htmlDecode(rawurldecode($item->title)) }}</a>
                                                        </h4>
                                                        <ul>
                                            ...
                                            @foreach($category->news()->limit(3)->get() as $category_news)
                                                ...
                                                <li>
                                                    ...
                                                    <div class="maan-list-text">
                                                        ...
                                                        <h4>
                                                            <a href="@if($category_news->categories->slug){{ route(strtolower($category_news->categories->slug).'.details',['id'=>$category_news->id,'slug'=>$category_news->slug]) }}@endif">{{ htmlDecode(rawurldecode($category_news->title)) }}</a>
                                                        </h4>
                                                        <ul>
                                                            <li class="author">
                                                        <span class="maan-icon">
                        ...
                        <div
                            ...
                            <div class="card maan-default-post">
                                ...
                                <div class="card-body maan-card-body">
                                    <div class="maan-text">
                                        <h4>
                                            <a href="@if($categories[0]->slug) {{ route(strtolower($categories[0]->slug).'.details',['id'=>$item->id,'slug'=>$item->slug]) }} @endif">{{ htmlDecode(rawurldecode($item->title)) }}</a>
                                        </h4>
                                        <ul>
                                            <li>
                                            <span class="maan-icon">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card maan-default-post">
                                                ...
                                                <div class="card-body maan-card-body">
                                                    <div class="maan-text">
                                                        <h4>
                                                            <a href="@if($categories[1]->slug) {{ route(strtolower($categories[1]->slug).'.details',['id'=>$item->id,'slug'=>$item->slug]) }} @endif">{{ htmlDecode(rawurldecode($item->title)) }}</a>
                                                        </h4>
                                                        <ul>
                                                            <li>
                                                        <span class="maan-icon">
                                                    ...
                                                    <a href="{{$social['url']}}" target="_blank">
                                                        ...
                                                        <div class="maan-text">
                                                            ...
                                                            <div class="maan-f-numbber"><span
                                                                    class="counter">{{$social['followers']}}</span>{{ __('K') }}
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                        ...
                        <div
                            ...
                            <div class="card maan-default-post">
                                ...
                                <div class="card-body maan-card-body">
                                    <div class="maan-text">
                                        <h4>
                                            <a href="@if($categories[2]->slug) {{ route(strtolower($categories[2]->slug).'.details',['id'=>$item->id,'slug'=>$item->slug]) }} @endif">{{ htmlDecode(rawurldecode($item->title)) }}</a>
                                        </h4>
                                        <ul>
                                            <li>
                                        <span class="maan-icon">
                        ...
                        <div class="col-lg-3">
                            <div class="card maan-default-post">
                                ...
                                <div class="card-body maan-card-body">
                                    <div class="maan-text">
                                        <h4>
                                            <a href="@if($categories[3]->slug) {{ route(strtolower($categories[3]->slug).'.details',['id'=>$item->id,'slug'=>$item->slug]) }} @endif">{{ htmlDecode(rawurldecode($item->title)) }}</a>
                                        </h4>
                                        <ul>
                                            <li>
                                        <span class="maan-icon">
