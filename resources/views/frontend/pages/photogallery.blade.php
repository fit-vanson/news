                                        ...
                                        <div class="maan-text">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <span
                                                        class="maan-item-text">{{ date("d M, Y", strtotime($photogallery->created_at)) }}</span>

                                                </li>
                                            </ul>
                                            <h4>
                                                <a href="{{ route('photogallery.details',$photogallery->id) }}">{{ $photogallery->title }}</a>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @foreach($popularphotogalleries as $popularnewsphotogallery)
                                <div class="card maan-default-post">
                                    ...
                                    <div class="card-body maan-card-body">
                                        <div class="maan-text">
                                            <h4>
                                                <a href="{{ route('photogallery.details',$popularnewsphotogallery->id) }}">{{ $popularnewsphotogallery->title }}</a>
                                            </h4>
                                            <ul>
                                                <li>
                                                    <span class="maan-icon"><svg viewBox="0 0 512 512"><path
                                                                ...
                                                                d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                                    <span
                                                        class="maan-item-text">{{ $popularnewsphotogallery->created_at->format('d M, Y') }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="widgets-gallery">
                            <ul>
                                ...
                                @foreach($photogalleries1 as $photogallery1)
                                    <li>
                                        <a href="{{ route('photogallery.details',$photogallery1->id) }}"><img
                                                src="{{ asset($photogallery1->image) }}" alt="gallery"></a>
                                    </li>
                                @endforeach
                                    ...
                                    <li>
                                        <div class="maan-list-img">
                                            <a href="{{ route('photogallery.details',$recentnewsphotogallery->id) }}">
                                                <img src="{{ asset($recentnewsphotogallery->image) }}"
                                                     alt="list-news-img">
                                            </a>
                                        </div>
                                        <div class="maan-list-text">
                                            <h4>
                                                <a href="{{ route('photogallery.details',$recentnewsphotogallery->id) }}">{{ $recentnewsphotogallery->title }}</a>
                                            </h4>
                                            <ul>
                                                <li>
                                                    <span class="maan-icon"><svg viewBox="0 0 512 512"><path
                                                                ...
                                                                d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                                    <span
                                                        class="maan-item-text">{{ $recentnewsphotogallery->created_at->format('d M, Y') }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
