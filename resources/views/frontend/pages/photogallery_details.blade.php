                        ...
                        <div class="maan-widgets">
                            <div class="widgets-tags">
                                <ul>
                                    @foreach(newscategories() as $newscategory)
                                        <li>
                                            <a href="@if(Route::has(strtolower($newscategory->slug))){{ route(strtolower($newscategory->slug),strtolower($newscategory->name)) }}@endif">{{$newscategory->name }}</a>
                                        </li>
                                    @endforeach
                        ...
                        <div class="col-lg-4">
                            <div class="card maan-default-post">
                                ...
                                <div class="card-body maan-card-body">
                                    <div class="maan-text">
                                        <h4>
                                            <a href="{{ route('photogallery.details',$relatedphotogallery->id) }}">{{ $relatedphotogallery->title }}</a>
                                        </h4>
                                        <ul>
                                            <li>
                                                <span class="maan-icon">
