                            ...
                            <div class="card maan-default-post">
                                ...
                                <div class="card-body maan-card-body">
                                    <div class="maan-text">
                                        <ul>
                                            <li>
                                                <span class="maan-icon"><svg viewBox="0 0 512 512"><circle cx="256"
                                                                                                           cy="114.526"
                                                                                                           r="114.526"></circle><path
                                                            d="M256,256c-111.619,0-202.105,90.487-202.105,202.105c0,29.765,24.13,53.895,53.895,53.895h296.421 c29.765,0,53.895-24.13,53.895-53.895C458.105,346.487,367.619,256,256,256z"></path></svg></span>
                                        ...
                                        <h4>
                                            <a href="{{ route($item->categories->slug.'.details',$item->id) }}">{{ htmlDecode(rawurldecode($item->title)) }}</a>
                                        </h4>
