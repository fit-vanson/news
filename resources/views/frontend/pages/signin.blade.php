...
@section('main_content')
    ...
    <section class="maan-signup-section maan-section">
        <div class="container">
            ...
            <form class="maan-signup-signin-form" action="{{ route('signin') }}" method="POST">
                @csrf
                ...
                <div class="maan-input-group">
                    ...
                    <div class="password-area">
                        <input id="password-field" type="password" class="form-control" placeholder="Password"
                               name="password">
                        <div toggle="#password-field" class="field-icon toggle-password">
                ...
                <button class="maan-btn">{{ __('Sign In') }}</button>
                <span>{{ __("Don't have an account?") }} <a
                        href="{{ route('signup') }}">{{ __('SignUp Now') }}</a></span>
            </form>
        </div>
    </section>
@endsection
