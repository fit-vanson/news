...
@section('main_content')
    ...
    <section class="maan-signup-section maan-section">
        <div class="container">
            <form class="maan-signup-signin-form" action="{{ route('signup') }}" method="POST">
                @csrf
                <h3>{{ __('Create your Account') }}</h3>
                <div class="maan-input-group">
                    <label for="firstName">{{ __('First Name') }}</label>
                    <input id="firstName" type="text" name="first_name" class="form-control" placeholder="First Name"
                ...
                <div class="maan-input-group">
                    ...
                    <input id="lastName" type="text" name="last_name" class="form-control" placeholder="Last Name"
                           value="{{old('last_name')}}">
                    @error('last_name')
                    <span class="text-danger">
                            {{$message}}
                ...
                <div class="maan-input-group">
                    <label for="phoneone">{{ __('Email') }}</label>
                    <input id="phoneone" type="text" name="email" class="form-control" placeholder="Email"
                           value="{{old('email')}}">
                    @error('email')
                    <span class="text-danger">
                            {{$message}}
                ...
                <div class="maan-input-group">
                    ...
                    <div class="password-area">
                        <input id="ps" type="password" class="form-control" placeholder="Password" name="password">
                        <div toggle="#ps" class="field-icon toggle-password">
                            <svg class="eye-show" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.992 511.992">
                            ...
                            <svg class="eye-close" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.001 512.001">
                ...
                <div class="maan-input-group">
                    ...
                    <div class="password-area">
                        ...
                        <div toggle="#passs" class="field-icon toggle-password">
                            <svg class="eye-show" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.992 511.992">
                                <path d="M510.096,249.937c-4.032-5.867-100.928-143.275-254.101-143.275C124.56,106.662,7.44,243.281,2.512,249.105
                                c-3.349,3.968-3.349,9.792,0,13.781C7.44,268.71,124.56,405.329,255.995,405.329S504.549,268.71,509.477,262.886
                                C512.571,259.217,512.848,253.905,510.096,249.937z M255.995,383.996c-105.365,0-205.547-100.48-230.997-128
                ...
                <span>{{ __("Already member?") }} <a href="{{ route('signin') }}">{{ __('SignIn here') }}</a></span>
            </form>
        </div>
    </section>
@endsection
