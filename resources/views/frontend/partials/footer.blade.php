...
@if($gtext['is_subscribe_footer'] == 1)
    <section class="footer-top"
             style="background-image: url({{ asset('media/'.$gtext['subscribe_background_image']) }});">
        <div class="container">
            <div class="row">
                <div
                    ...
                    <div class="newsletter-card">
                        ...
                        <div class="newsletter-form">
                            <form>
                                ...
                                <a class="btn newsletter-btn subscribe_btn sub_btn"
...
<!-- /Telegram -->
@if($gtext['is_telegram_publish'] == 1)
    <div class="telegram-{{ $gtext['position'] }}">
        <a href="https://t.me/{{ $gtext['telegram_id'] }}" target="_blank" class="telegram-btn">
            <img src="{{ asset('media/telegram.png') }}"/>
        </a>
    </div>
@endif
<!-- /Telegram -->
