...
<!-- Home Slider -->
	@if($section1->is_publish == 1)
        ...
        <section class="slider-section">
            <div class="slider-screen h1-height" style="background-image: url({{ $section1->pivot->image ? asset('media/'.$section1->pivot->image) : '' }});">
        @else
            <section class="slider-section">
	...
	<!-- /Home Slider/ -->
	<!-- Featured Categories -->
	@if($section2->is_publish == 1 && count($pro_category) > 0 )
    @if($section2->pivot)
        ...
        @else
            <section class="section" style="background-image: url({{ $section2->image ? asset('media/'.$section2->image) : '' }});">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-heading">
	...
	<!-- Popular Products -->
	@if($section3->is_publish == 1 && count($popular_products) >0)
...
{{--						</div>--}}
	...
	<!-- Offer Section -->
	@if($section4->is_publish == 1 && count($offer_ad_position1) >0)
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="section-heading">
                        @if($section5->pivot)
                            @if($section5->pivot->desc !='')
                            <h5>{{ $section5->pivot->desc }}</h5>
                            @endif

                            @if($section5->pivot->title !='')
                            <h2>{{ $section5->pivot->title }}</h2>
                            @endif
                        @else
                            @if($section5->desc !='')
                                <h5>{{ $section5->desc }}</h5>
				...
				<div class="col-lg-12">
					<ul class="nav nav-pills tp-tabs" id="pills-tab" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="pills-newProducts-tab" data-bs-toggle="pill" data-bs-target="#pills-newProducts" type="button" role="tab" aria-controls="pills-newProducts" aria-selected="true">{{ $section8->pivot ?$section8->pivot->title : $section8->title }}</button>
						</li>
						@endif
						@if($section9->is_publish == 1)
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="pills-topSelling-tab" data-bs-toggle="pill" data-bs-target="#pills-topSelling" type="button" role="tab" aria-controls="pills-topSelling" aria-selected="false">{{ $section9->pivot ? $section9->pivot->title : $section9->title }}</button>
						</li>
						@endif
						@if($section10->is_publish == 1)
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="pills-trendingProducts-tab" data-bs-toggle="pill" data-bs-target="#pills-trendingProducts" type="button" role="tab" aria-controls="pills-trendingProducts" aria-selected="false">{{ $section10->pivot ? $section10->pivot->title : $section10->title }}</button>
						</li>
						@endif
						@if($section11->is_publish == 1)
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="pills-topRated-tab" data-bs-toggle="pill" data-bs-target="#pills-topRated" type="button" role="tab" aria-controls="pills-topRated" aria-selected="false">{{ $section11->pivot ? $section11->pivot->title : $section11->title }}</button>
						</li>
						@endif
					</ul>
				</div>
