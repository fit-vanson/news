...
<!-- Home Slider -->
	...
	<div class="container-fluid g-0">
		<div class="row g-0">
			@php  $row = $slider[0];
                $aRow = json_decode($row->desc); @endphp
			<div class="col-lg-6">
			...
			<div class="col-lg-6">
				<div class="row g-0">
                    @for($i = 1;  $i < 5 ; $i++ )
					@php @$aRow = json_decode(@$slider[$i]->desc); @endphp
					<div class="col-lg-6">
						<div class="banner_card">
							<div class="banner_image">
								<img src="{{ asset('media/'.@$slider[$i]->image) }}" alt="{{ @$slider[$i]->title }}" />
							</div>
							<div class="banner_desc">
								...
								@endif
								@if(@$aRow->button_text != '')
								<a href="{{ @$slider[$i]->url }}" class="btn theme-btn" {{ @$aRow->target =='' ? '' : "target=".@$aRow->target }}>{{ @$aRow->button_text }}</a>
								@endif
							</div>
						</div>
					</div>
...
{{--								</div>--}}
    ...
    @if($section8->pivot)
    <section class="section product-section" style="background-image: url({{ $section8->pivot->image ? asset('media/'.$section8->pivot->image) : '' }});">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section-heading">
...
{{--						</div>--}}
    ...
    @if($section3->pivot)
        <section class="section product-section" style="background-image: url({{ $section3->pivot->image ? asset('media/'.$section3->pivot->image) : '' }});">
            <div class="container">
                <div class="row">
                    <div class="col">
    ...
    @else
        <section class="section product-section" style="background-image: url({{ $section3->image ? asset('media/'.$section3->image) : '' }});">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-heading text-center">
...
{{--						</div>--}}
    ...
    @if($section9->pivot)
        <section class="section product-section" style="background-image: url({{ $section9->pivot->image ? asset('media/'.$section9->pivot->image) : '' }});">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-heading text-center">
...
{{--						</div>--}}
	...
	@if($section8->is_publish == 1)
    @if($section11->pivot)
        <section class="section product-section" style="background-image: url({{ $section11->pivot->image ? asset('media/'.$section11->pivot->image) : '' }});">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-heading text-center">
...
{{--	@endif--}}
    ...
    @if($section10->pivot)
        <section class="section product-section" style="background-image: url({{ $section10->pivot->image ? asset('media/'.$section10->pivot->image) : '' }});">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-heading text-center">
    ...
    @else
        <section class="section product-section" style="background-image: url({{ $section10->image ? asset('media/'.$section10->image) : '' }});">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-heading text-center">
