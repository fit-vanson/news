...
Route::prefix('backend')->group(function(){
    ...
    Route::post('/saveProductsBulk', [App\Http\Controllers\Backend\ProductsController::class, 'saveProductsBulk'])->name('backend.saveProductsBulk')->middleware(['auth','is_admin']);
    ...
    Route::post('/saveProductCategoriesBulk', [App\Http\Controllers\Backend\Pro_categoriesController::class, 'saveProductCategoriesBulk'])->name('backend.saveProductCategoriesBulk')->middleware(['auth','is_admin']);
    ...
    Route::post('/saveBrandsBulk', [App\Http\Controllers\Backend\BrandsController::class, 'saveBrandsBulk'])->name('backend.saveBrandsBulk')->middleware(['auth','is_admin']);
    ...
    //Theme Options Telegram
    Route::get('/theme-options-telegram', [App\Http\Controllers\Backend\ThemeOptionsController::class, 'getThemeOptionsTelegramPageLoad'])->name('backend.theme-options-telegram')->middleware(['auth','is_admin']);
    Route::post('/saveThemeOptionsTelegram', [App\Http\Controllers\Backend\ThemeOptionsController::class, 'saveThemeOptionsTelegram'])->name('backend.saveThemeOptionsTelegram')->middleware(['auth','is_admin']);


    //Social Media
	Route::get('/social-media/{id?}', [App\Http\Controllers\Backend\SocialMediasController::class, 'getSocialMediaPageLoad'])->name('backend.social-media')->middleware(['auth','is_admin']);
...
//	Route::post('/BankSettingsUpdate', [App\Http\Controllers\Backend\SettingsController::class, 'BankSettingsUpdate'])->name('backend.BankSettingsUpdate')->middleware(['auth','is_admin']);
    ...
    //Bank Transfer
    Route::get('/bank-transfer', [App\Http\Controllers\Backend\ThemeOptionsController::class, 'getThemeOptionsBankTransferPageLoad'])->name('backend.bank-transfer')->middleware(['auth','is_admin']);
    Route::post('/BankSettingsUpdate', [App\Http\Controllers\Backend\ThemeOptionsController::class, 'saveThemeOptionsBankTransfer'])->name('backend.saveThemeOptionsBankTransfer')->middleware(['auth','is_admin']);
